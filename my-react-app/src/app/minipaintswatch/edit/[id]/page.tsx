...
export default function MiniPaintSwatchEdit() {
    const { id } = useParams();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const result = await miniPaintSwatchService.updateAsync({
                id: id!,
                usageType: data!.usageType,
                notes: data!.notes,
                miniatureCollectionId: data!.miniatureCollectionId,
                personPaintsId: data!.personPaintsId
            });
